#############################################################################
# Makefile for building: Feetech_servo_gui.app/Contents/MacOS/Feetech_servo_gui
# Generated by qmake (3.1) (Qt 6.9.1)
# Project:  Feetech_servo_gui.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile Feetech_servo_gui.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Feetech_servo_gui1.0.0
DISTDIR = /Users/rafaelcaricio/development/feetech_scs_servo_gui/.tmp/Feetech_servo_gui1.0.0
...
LIBS          = $(SUBLIBS) -F/opt/homebrew/lib -framework QtWidgets -framework QtGui -framework AppKit -framework ImageIO -framework Metal -framework QtSerialPort -framework QtCore -framework IOKit -framework DiskArbitration -framework UniformTypeIdentifiers -framework AGL -framework OpenGL   
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		Feetech_servo_gui.pro mainwindow.h \
		SCServo.h \
		SCSProtocol.h main.cpp \
		mainwindow.cpp \
		SCServo.cpp \
		SCSProtocol.cpp
QMAKE_TARGET  = Feetech_servo_gui
DESTDIR       = 
TARGET        = Feetech_servo_gui.app/Contents/MacOS/Feetech_servo_gui

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.5
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Applications/Xcode.app/Contents/Developer
EXPORT__QMAKE_STASH_ = /Users/rafaelcaricio/development/feetech_scs_servo_gui/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/rafaelcaricio/development/feetech_scs_servo_gui/Feetech_servo_gui.pro
...
Feetech_servo_gui.app/Contents/MacOS/Feetech_servo_gui: ui_mainwindow.h $(OBJECTS)  
	@test -d Feetech_servo_gui.app/Contents/MacOS/ || mkdir -p Feetech_servo_gui.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: Feetech_servo_gui.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile Feetech_servo_gui.pro
...
Feetech_servo_gui.app/Contents/PkgInfo: 
	@test -d Feetech_servo_gui.app/Contents || mkdir -p Feetech_servo_gui.app/Contents
	@$(DEL_FILE) Feetech_servo_gui.app/Contents/PkgInfo
	@echo "APPL????" > Feetech_servo_gui.app/Contents/PkgInfo
Feetech_servo_gui.app/Contents/Info.plist: 
	@test -d Feetech_servo_gui.app/Contents || mkdir -p Feetech_servo_gui.app/Contents
	@$(DEL_FILE) Feetech_servo_gui.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,social.nullpointer.Feetech-servo-gui,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},social.nullpointer.Feetech-servo-gui,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,Feetech_servo_gui,g" -e "s,@LIBRARY@,Feetech_servo_gui,g" -e "s,\$${EXECUTABLE_NAME},Feetech_servo_gui,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >Feetech_servo_gui.app/Contents/Info.plist

all: Makefile \
		Feetech_servo_gui.app/Contents/PkgInfo \
		Feetech_servo_gui.app/Contents/Info.plist Feetech_servo_gui.app/Contents/MacOS/Feetech_servo_gui
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h SCServo.h SCSProtocol.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp SCServo.cpp SCSProtocol.cpp $(DISTDIR)/
...
distclean: clean 
	-$(DEL_FILE) -r Feetech_servo_gui.app
...
qrc_icons.cpp: icons.qrc \
		...
		icons/icon.jpg
	/opt/homebrew/share/qt/libexec/rcc -name icons icons.qrc -o qrc_icons.cpp
...
SCServo.o: SCServo.cpp SCServo.h \
		SCSProtocol.h \
		/opt/homebrew/lib/QtSerialPort.framework/Headers/QSerialPort \
		/opt/homebrew/lib/QtSerialPort.framework/Headers/qserialport.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QDebug \
		/opt/homebrew/lib/QtCore.framework/Headers/qdebug.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SCServo.o SCServo.cpp

SCSProtocol.o: SCSProtocol.cpp SCSProtocol.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o SCSProtocol.o SCSProtocol.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Feetech_servo_gui/bin || mkdir -p $(INSTALL_ROOT)/opt/Feetech_servo_gui/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/Feetech_servo_gui/bin/Feetech_servo_gui.app
	
	$(QINSTALL) Feetech_servo_gui.app $(INSTALL_ROOT)/opt/Feetech_servo_gui/bin/Feetech_servo_gui.app
	-$(STRIP) $(INSTALL_ROOT)/opt/Feetech_servo_gui/bin/Feetech_servo_gui.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/Feetech_servo_gui/bin/Feetech_servo_gui.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Feetech_servo_gui/bin/ 
